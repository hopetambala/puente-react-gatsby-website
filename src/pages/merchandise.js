...
const MerchandisePage = () => {
  const data = useStaticQuery(
    graphql`
    query {
      enUS_contentfulMerchandisePage: contentfulMerchandisePage(node_locale: { eq: "en-US" }) {
        headerText
        headerSubText {
          childMarkdownRemark {
            html
      ...
      esDO_contentfulMerchandisePage: contentfulMerchandisePage(node_locale: { eq: "es-DO" }) {
        headerText
        headerSubText {
          childMarkdownRemark {
            html
  ...
  let contentfulMerchandisePage = LANGUAGESETTINGS.contentfulMerchandisePage
  return (
    <div>
      <Layout>
